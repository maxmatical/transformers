...
python3 ./examples/run_squad_max.py \
    --model_type albert \
    --model_name_or_path /scratch/gobi1/mtian/models/albertx_squad_max_beta2_98_lr_5e-5/\
    --do_train \
    --do_lower_case \
    ...
    --max_seq_length 384 \
    --doc_stride 128 \
    --output_dir /scratch/gobi1/mtian/models/bioasq_albertx_v2_6epoch_lr5e-6_sq/ \
