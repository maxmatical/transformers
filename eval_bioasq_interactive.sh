...
python3 ./examples/run_squad_max.py \
   --model_type bert \
   --model_name_or_path /scratch/gobi1/mtian/models/bioasq_bert_lre5-6_sq/ \
   --do_eval \
   --do_lower_case \
...
python3 transform_nbset2bioasqform.py --nbest_path=/scratch/gobi1/mtian/models/bioasq_bert_lre5-6_sq/nbest_predictions_.json --output_path=/scratch/gobi1/mtian/models/bioasq_bert_lre5-6_sq/
...
scp mtian@q.vectorinstitute.ai:/scratch/gobi1/mtian/models/bioasq_bert_lre5-6_sq/BioASQform_BioASQ-answer.json BioASQform_BioASQ-answer_bert_sq_bioasq.json 